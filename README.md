...
### 3. Resolver o exercício 38:
 Gravando todos os valores num arquivo e, no final do arquivo, gravar o
maior e o menor, deixando escrito qual é o maior e qual é o menor. A gravação do arquivo deve
estar em um procedimento.

### 4. Baseado no exercício anterior:
 Fazer um algoritmo modularizando que lê o arquivo de saída,
